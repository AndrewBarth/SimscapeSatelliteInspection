function [momentum,desired_rates,momentumDelta] = dualArmStabilizationControl(time,Hom1,geometry1,massProperties1,nLink1,Hom2,geometry2,massProperties2,nLink2,base_state,baseMP,arm1_state,arm2_state)
