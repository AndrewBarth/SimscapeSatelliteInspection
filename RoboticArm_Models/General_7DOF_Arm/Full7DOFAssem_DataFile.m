...
smiData.RevoluteJoint(1).ID = "[ElbowAssem-1:MainLink2-1:-:ElbowAssem-1:ElbowJoint_2-1]";

smiData.RevoluteJoint(2).Rz.Pos = 87.961256212002453;  % deg
smiData.RevoluteJoint(2).ID = "[ShoulderAssm-1:ShoulderBase-1:-:ShoulderAssm-1:ShoulderJoint_1-1]";

smiData.RevoluteJoint(3).Rz.Pos = 0;  % deg
smiData.RevoluteJoint(3).ID = "[ShoulderAssm-1:ShoulderBase-1:-:Base-1]";

smiData.RevoluteJoint(4).Rz.Pos = -95.03088396129948;  % deg
smiData.RevoluteJoint(4).ID = "[WristAssem-1:WristJoint_2-1:-:Gripper-1]";

smiData.RevoluteJoint(5).Rz.Pos = 1.4699495843535755;  % deg
smiData.RevoluteJoint(5).ID = "[ShoulderAssm-1:ShoulderJoint_3-4:-:ElbowAssem-1:MainLink1-1]";
