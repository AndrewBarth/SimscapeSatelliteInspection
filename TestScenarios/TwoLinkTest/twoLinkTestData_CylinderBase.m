...
% config 4: octagon base arms at center
% config 5: octagon base arms at front
...
sat.service.MoI = [0.0698657, 0.0698657, 0.0563981];
...
elseif config == 4
    ...
    arm(1).armAttachPnt = [-0.25 0 0];
    arm(2).armAttachPnt = [ 0.25 0 0];
    
    arm(1).baseOffset = [.0 -.25 -0.04];
    arm(2).baseOffset = [.0 -.25 -0.04];
elseif config == 5
    arm(1).armAttachAngles = [0 0 180]*pi/180;
    arm(2).armAttachAngles = [0 0 0]*pi/180;
    
    arm(1).armAttachPnt = [-0.25 0.2 0];
    arm(2).armAttachPnt = [ 0.25 0.2 0];
    
    arm(1).baseOffset = [-0.1  -.05 -0.04];
    arm(2).baseOffset = [ 0.1  -.05 -0.04];
end
