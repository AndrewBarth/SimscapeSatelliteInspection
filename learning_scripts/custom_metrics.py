...
#        reward_states = episode.user_data['reward_states']
        ...
        for agent_key in agent_keys:
            combined_metrics = []
            for (w,x,y,z) in zip(episode.user_data['output_states'][agent_key], episode.user_data['error_states'][agent_key], episode.user_data['action_states'][agent_key],episode.user_data['reward_states'][agent_key]):
                combined_metrics.append(w+x+y+z)
